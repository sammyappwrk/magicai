...
Route::get('/google-absense-list', [AbsenseController::class, 'absenseList']);
Route::post('/add-google-absense-list', [AbsenseController::class, 'addAbsense']);
Route::post('/get-specific-google-absense', [AbsenseController::class, 'getSpecificAbsense']);
